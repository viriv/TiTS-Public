		...
		public override function getDescription(target:Creature):String
		{
			...
			switch(this.tattooLocation)
			{
				...
				case "left chest"://doc didn't have a L/R floral pattern on flat chests so some got made up
					...
					if(target.hasBreasts()) ret = "Petals rise up from beneath your " + (matchingRightTattoo ? "breasts" : "left breast" + (target.bRows() > 1 ? "s" : "")) + ", wrapping " + (matchingRightTattoo ? "your bust" : target.bRows() > 1 ? "them" : "it") + " in a " + this.color + (matchingRightTattoo && target.rightChestTattoo.color != target.leftChestTattoo.color ? " and " + target.rightChestTattoo.color : "") + " floral bloom. " + (matchingRightTattoo ? "Blossoms burst" : "A blossom bursts") + " out and sensuously display" + (matchingRightTattoo ? "" : "s") + " your [pc.nippleColor] areola" + (matchingRightTattoo || target.bRows() > 1 ? "e" : "") + ", your " + (matchingRightTattoo ? "[pc.nipplesNoun]" : "[pc.nippleNoun]") + " in the center.";
				...
				case "right chest"://doc didn't have a L/R floral pattern on flat chests so some got made up
					...
					if(target.hasBreasts()) ret = "Petals rise up from beneath your " + (matchingLeftTattoo ? "breasts" : "right breast" + (target.bRows() > 1 ? "s" : "")) + ", wrapping " + (matchingLeftTattoo ? "your bust" : target.bRows() > 1 ? "them" : "it") + " in a " + this.color + (matchingLeftTattoo && target.rightChestTattoo.color != target.leftChestTattoo.color ? " and " + target.leftChestTattoo.color : "") + " floral bloom. " + (matchingLeftTattoo ? "Blossoms burst" : "A blossom bursts") + " out and sensuously display" + (matchingLeftTattoo ? "" : "s") + " your [pc.nippleColor] areola" + (matchingLeftTattoo || target.bRows() > 1 ? "e" : "") + ", your " + (matchingLeftTattoo ? "[pc.nipplesNoun]" : "[pc.nippleNoun]") + " in the center.";
