...
public function moreGetFuckedByKrissy2():void
{
	...
	output("\n\n<i>“Fuck you look good like that,”</i> Krissy coos. She climbs back on top of you, slapping her cock " + (pc.biggestTitSize() >= 3 ? "into":"onto") + " your [pc.chest]. <i>“Maybe I should’ve wrapped this present.”</i> She thumbs on of your nipples before leaning down to give you a kiss through your mouthful of cum. <i>“But I always did like to ice a set of sugar cookies.”</i> Giggling to herself, Krissy squeezes a few flecks of cum onto your tits to complete the image.");
	var krissyPreggoStuff:PregnancyPlaceholder = new PregnancyPlaceholder();
	krissyPreggoStuff.createPerk("Fixed CumQ", 25000, 0, 0, 0);
	processTime(25);
	pc.applyCumSoaked();
...
public function gushyGushSantaShit():void
{
	...
	{
		output(" [pc.Cum] ");
		if(pc.cumQ() < 10) output("dribbles all over Krissy’s fingers");
		else if(pc.cumQ() < 50) output("shoots up to splatter back down on Krissy’s fingers");
		else if(pc.cumQ() < 5000) output("erupts in thick, wet blasts, slapping into the underside of Krissy’s tits to hang in gooey webs.");
